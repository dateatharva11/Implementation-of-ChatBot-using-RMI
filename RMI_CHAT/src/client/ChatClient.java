...
public class ChatClient  extends UnicastRemoteObject implements ChatClientIF {
	...
	private String serviceName = "ChatBotService";
	...
	//Register our own listening service/interface lookup the server RMI interface, then send our details
	...
	//pass our username, hostname and RMI service name to the server to register out interest in joining the chat
	...
	//This is the clients RMI method, which will be used by the server to send messages to us
	@Override
	...
	//A method to update the user currently connected to the server
	@Override
