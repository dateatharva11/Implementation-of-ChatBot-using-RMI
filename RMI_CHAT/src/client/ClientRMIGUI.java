...
public class ClientRMIGUI extends JFrame implements ActionListener{
	...
	//Method to get currently connected user with a call to the button panel building method
	...
	//The buttons and event listener
		...
		try {
			...
			if(e.getSource() == startButton){
				...
				if(name.length() != 0){
					...
					textField.setText("");
					textArea.append("Username : " + name + " connecting to chatbot...\n");							
					getConnected(name);
